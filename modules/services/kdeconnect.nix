...
in {
  ...
  config = lib.mkMerge [
    (lib.mkIf cfg.enable {
      ...
      assertions = [
        (lib.hm.assertions.assertPlatform "services.kdeconnect" pkgs
          lib.platforms.linux)
      ];
      ...
      systemd.user.services.kdeconnect = {
        ...
        Service = {
          ...
          ExecStart = if lib.strings.versionAtLeast
          (lib.versions.majorMinor cfg.package.version) "24.05" then
