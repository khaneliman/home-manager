{
  ...
  files-recursive-overlap-dangling-ignore = ./recursive-overlap-dangling-ignore.nix;
  files-recursive-overlap-dangling-override = ./recursive-overlap-dangling-override.nix;
