...

{
  config = {
    ...
    nmt.script = ''
      ...
      assertFileExists "home-files/$configDir/External Extensions/aaaaaaaaaabbbbbbbbbbcccccccccc.json"
      ...
      local_config="home-files/$configDir/External Extensions/aaaaaaaaaabbbbbbbbbbcccccccccc.json"
