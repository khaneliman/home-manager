...
in
{
  ...
  test.asserts.warnings.expected = [
    ''
      Using `programs.firefox.profiles.default.bookmarks` defined in ${lib.showFiles options.programs.firefox.profiles.files} as an attribute set is deprecated and will be
